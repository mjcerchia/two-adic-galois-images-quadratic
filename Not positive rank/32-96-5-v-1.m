...
[
    ...
    48*x[1]^2 - 8*x[1]*x[3] + x[3]^2 + 2*x[4]*x[6] - 20*x[6]^2 + 2*x[7]^2,
    x[1]*x[2] - x[7]^2,
    x[1]*x[4] - x[3]*x[6],
    x[1]*x[5] - x[4]*x[6],
    x[3]*x[4] + 48*x[1]*x[6] - 8*x[3]*x[6] + 2*x[5]*x[6] - 20*x[6]*x[7] + 
        2*x[7]*x[8],
    -x[6]^2 + x[1]*x[7],
    -x[6]*x[7] + x[1]*x[8],
    2*x[2]^2 + 2*x[2]*x[5] + x[5]^2 - 8*x[5]*x[7] + 48*x[7]^2 - 20*x[8]^2,
    x[2]*x[3] - x[5]*x[7],
    x[2]*x[4] - x[5]*x[8],
    x[2]*x[6] - x[7]*x[8],
    x[2]*x[7] - x[8]^2,
    x[4]*x[5] - 8*x[5]*x[6] + 48*x[6]*x[7] + 2*x[2]*x[8] + 2*x[5]*x[8] - 
        20*x[7]*x[8],
    x[3]*x[5] - 8*x[4]*x[6] + 48*x[6]^2 + 2*x[5]*x[7] - 20*x[7]^2 + 2*x[8]^2,
    -x[4]*x[6] + x[3]*x[7],
    -x[5]*x[6] + x[3]*x[8],
    x[4]^2 - 8*x[4]*x[6] + 48*x[6]^2 + 2*x[5]*x[7] - 20*x[7]^2 + 2*x[8]^2,
    -x[5]*x[6] + x[4]*x[7],
    -x[5]*x[7] + x[4]*x[8],
    -x[7]^2 + x[6]*x[8]
]
