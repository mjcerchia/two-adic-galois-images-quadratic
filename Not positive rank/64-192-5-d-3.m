...
Let C be the modular curve with lmfdb label 64.192.5.d.3.
...
[
    ...
    x[2]*x[6] - x[7]*x[8],
    x[2]*x[7] - x[8]^2,
    -x[5]^2 + x[2]*x[8] + x[7]*x[8],
    x[3]*x[4] - x[6]^2 - x[7]^2,
    x[3]*x[5] - x[6]*x[7] - x[7]*x[8],
    -x[4]*x[6] + x[3]*x[7],
    -x[5]*x[6] + x[3]*x[8],
    x[4]^2 - x[6]*x[7] - x[7]*x[8],
    x[4]*x[5] - x[7]^2 - x[8]^2,
    -x[5]*x[6] + x[4]*x[7],
    -x[5]*x[7] + x[4]*x[8],
    -x[7]^2 + x[6]*x[8]
