...
Let C be the modular curve with lmfdb label 32.96.5.v.2.
...
C := Curve(P,[2*x^2 + w*t, 2*y^2 - 8*y*z + t^2, 2*y*z + 8*z^2 - w^2]);
...
[
    ...
    x[1]*x[4] - x[3]*x[6],
    x[1]*x[5] - x[4]*x[6],
    x[3]*x[4] + 256*x[1]*x[6] - 48*x[6]*x[7] + 2*x[7]*x[8],
    -x[6]^2 + x[1]*x[7],
    -x[6]*x[7] + x[1]*x[8],
    2*x[2]^2 + x[5]^2 + 256*x[7]^2 - 48*x[8]^2,
    x[2]*x[3] - x[5]*x[7],
    x[2]*x[4] - x[5]*x[8],
    x[2]*x[6] - x[7]*x[8],
    x[2]*x[7] - x[8]^2,
    x[4]*x[5] + 256*x[6]*x[7] + 2*x[2]*x[8] - 48*x[7]*x[8],
    x[3]*x[5] + 256*x[6]^2 - 48*x[7]^2 + 2*x[8]^2,
    -x[4]*x[6] + x[3]*x[7],
    -x[5]*x[6] + x[3]*x[8],
    x[4]^2 + 256*x[6]^2 - 48*x[7]^2 + 2*x[8]^2,
    -x[5]*x[6] + x[4]*x[7],
    -x[5]*x[7] + x[4]*x[8],
    -x[7]^2 + x[6]*x[8]
]
