...
[
    ...
    x[1]^2 - 4*x[1]*x[4] - 4*x[4]^2 - 1024*x[6]^2 - 1024*x[6]*x[7],
    x[1]*x[2] - x[6]^2,
    x[1]*x[3] - x[7]^2,
    x[1]*x[5] - x[4]*x[6],
    x[1]*x[6] - x[4]*x[7],
    -4*x[4]*x[6] + x[1]*x[7] - 4*x[4]*x[7] - 1024*x[6]*x[8] - 1024*x[7]*x[8],
    -x[6]*x[7] + x[1]*x[8],
    1024*x[2]^2 + 4*x[5]^2 - 5*x[6]^2 + x[6]*x[7] - 1024*x[8]^2,
    x[2]*x[3] - x[8]^2,
    x[2]*x[4] - x[5]*x[6],
    x[2]*x[6] - x[5]*x[8],
    x[2]*x[7] - x[6]*x[8],
    4*x[5]*x[6] + 4*x[6]^2 - x[6]*x[7] + 1024*x[2]*x[8] + 1024*x[8]^2,
    x[3]*x[4] - x[6]*x[7],
    x[3]*x[5] - x[6]*x[8],
    x[3]*x[6] - x[7]*x[8],
    4*x[6]^2 + 4*x[6]*x[7] - x[7]^2 + 1024*x[3]*x[8] + 1024*x[8]^2,
    4*x[4]*x[5] + 4*x[4]*x[6] - x[4]*x[7] + 1024*x[5]*x[8] + 1024*x[6]*x[8],
    -x[6]^2 + x[4]*x[8],
    -x[6]^2 + x[5]*x[7]
]
*/
