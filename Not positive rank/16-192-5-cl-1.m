...
Let C be the modular curve with lmfdb label 16.192.5.cl.1.
...
[
    ...
    x[1]*x[5] + 2*x[6]*x[7] + 4*x[2]*x[8],
    4*x[1]*x[7] + x[6]*x[8],
    3*x[2]^2 + 2*x[2]*x[4] + 4*x[7]^2,
    4*x[2]*x[6] + x[7]*x[8],
    2*x[1]*x[2] + 3*x[8]^2,
    2*x[3]*x[4] + x[1]*x[5] + x[1]*x[6] + 4*x[2]*x[8]
]*/
