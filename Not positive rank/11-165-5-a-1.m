...
C := Curve(P,[3*x^2 + 3*x*y - x*z - 3*x*w + 3*x*t + 3*y^2 + 2*y*z - y*w - 2*z^2 - 2*z*w + 2*z*t + w^2, 2*x*y - 2*x*z + 6*x*w - x*t - 3*y^2 + 3*y*z - y*t + 2*z^2 - 7*z*w - z*t - t^2, 8*x^2 - 10*x*y + 5*x*z - 3*x*w - x*t - 3*y^2 + 3*y*z + 4*y*w + 3*y*t - 3*z^2 - 7*z*w - z*t + 3*w^2 + 3*w*t - t^2]);
