...
Let C be the modular curve with lmfdb label 16.192.9.bq.4.
...
C := Curve(P,[z^2 + v*s, y*w - w^2 + s^2, y*t + z^2 - r^2, z*t + v*r, z*t - \
u*s, y*w + w^2 - v^2, y^2 - w^2 + u*r, y*t - z^2 + u^2, z*r - t*s, z*u + t*v, \
t^2 - u*r, z^2 + w*t, z*s + w*r, z*v - w*u, y*u - z*v - t*r, y*r - z*s + t*u, \
y*s + z*u + w*s, y*v + z*r - w*v, y*z - z*w - r*s, y*z + z*w - u*v, 2*x^2 - y*\
z]);
