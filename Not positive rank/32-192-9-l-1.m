...
Let C be the modular curve with lmfdb label 32.192.9.l.1.
...
*w, z*v + t*u - v^2, z*v - t*u + v^2 + r^2, x*t + w*r - v*s, x*z - y^2 + t*r, \
x*z + y^2 + u*s, x*u - z*r + w*s + v*r, 2*z^2 + r^2 + s^2, 2*w*t - u*v, 2*x*v \
+ t*r, x*r - 2*w*u - t*v, 2*w*v + t^2, x^2 + z*w + t^2 + u^2, x^2 + z*w - t^2 \
