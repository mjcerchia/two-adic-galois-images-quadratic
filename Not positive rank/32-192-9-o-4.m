...
Let C be the modular curve with lmfdb label 32.192.9.o.4.
...
C := Curve(P,[y*z - r^2, z*t + u*r, y*u + t*r, z*v - t*u, t^2 + v*r, w*u - v\
*r, y*u + z*w, y*t - w*r, y*v + w*t, y*t + w*r - u*s, x^2 + y*w + z*u, x^2 - y\
*w + z*u - t*s, 2*y^2 + r*s, 2*w^2 - v*s, 2*z^2 + v*r - r*s, z*t + w*v - w*s -\
 u*r, 2*u^2 - v^2 + v*s, 2*y*r + z*s, y*v - y*s + 2*z*r, x^2 + y*w - z*u + t*v\
 - t*s, 2*y*z - v*s + 2*r^2 + s^2]);
