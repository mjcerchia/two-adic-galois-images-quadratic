...
Let C be the modular curve with lmfdb label 32.192.9.o.1.
...
C := Curve(P,[y^2 - t*r, y^2 + r*s - s^2, y^2 + v^2 - v*r, y^2 - y*z - u*s, \
u*r + v*r - v*s, y*w + u*v - u*r, y^2 + y*w - t*s, t*v - u*s, y*w - z*w - t*u,\
 y*z - z^2 - t^2, y*t - w*s, y*t - z*v, y*u - w*v, z*u - w*t, y*w + w^2 - t^2,\
 t^2 + u^2 + u*v - u*s, y*t - y*u - z*t - w*u, y*v - y*r + z*r, y*u - z*r + z*\
s - w*r, y*r - y*s + w*r, 2*x^2 + y*u + y*r - 2*z*s + w*v]);
...
[
    ...
    x[3]*x[5] + 2*x[1]*x[12] + x[1]*x[14],
    x[3]*x[6] + 2*x[1]*x[13] + x[1]*x[15],
    x[3]*x[7] + 2*x[1]*x[14] + x[1]*x[16],
    x[1]*x[2] + x[3]*x[8] + 2*x[1]*x[15],
    ...
    2*x[1]*x[9] + x[3]*x[15],
    2*x[9]*x[10] + x[3]*x[16],
    x[4]^2 + 2*x[1]*x[12] + x[1]*x[14],
    x[4]*x[5] + 2*x[1]*x[13] + x[1]*x[15],
    x[4]*x[6] + 2*x[1]*x[14] + x[1]*x[16],
    x[1]*x[2] + x[4]*x[7] + 2*x[1]*x[15],
    x[4]*x[8] + x[2]*x[10] + 2*x[1]*x[16],
    2*x[1]*x[2] + x[4]*x[9] + x[2]*x[11],
    2*x[1]*x[5] + x[4]*x[10],
    2*x[1]*x[6] + x[4]*x[11],
    2*x[1]*x[7] + x[4]*x[12],
    2*x[1]*x[8] + x[4]*x[13],
    ...
    2*x[9]*x[10] + x[4]*x[15],
    2*x[2]*x[3] + x[4]*x[16],
    x[5]^2 + 2*x[1]*x[14] + x[1]*x[16],
    x[1]*x[2] + x[5]*x[6] + 2*x[1]*x[15],
    x[5]*x[7] + x[2]*x[10] + 2*x[1]*x[16],
    2*x[1]*x[2] + x[5]*x[8] + x[2]*x[11],
    x[5]*x[9] + 2*x[2]*x[10] + x[2]*x[12],
    2*x[1]*x[6] + x[5]*x[10],
    2*x[1]*x[7] + x[5]*x[11],
    2*x[1]*x[8] + x[5]*x[12],
    2*x[1]*x[9] + x[5]*x[13],
    ...
    x[6]*x[8] + 2*x[2]*x[10] + x[2]*x[12],
    x[6]*x[9] + 2*x[2]*x[11] + x[2]*x[13],
    2*x[1]*x[7] + x[6]*x[10],
    2*x[1]*x[8] + x[6]*x[11],
    2*x[1]*x[9] + x[6]*x[12],
    2*x[9]*x[10] + x[6]*x[13],
    ...
    x[7]*x[8] + 2*x[2]*x[11] + x[2]*x[13],
    x[7]*x[9] + 2*x[2]*x[12] + x[2]*x[14],
    2*x[1]*x[8] + x[7]*x[10],
    2*x[1]*x[9] + x[7]*x[11],
    2*x[9]*x[10] + x[7]*x[12],
    2*x[2]*x[3] + x[7]*x[13],
    ...
    2*x[2]*x[5] + x[7]*x[15],
    2*x[2]*x[6] + x[7]*x[16],
    x[8]^2 + 2*x[2]*x[12] + x[2]*x[14],
    x[8]*x[9] + 2*x[2]*x[13] + x[2]*x[15],
    2*x[1]*x[9] + x[8]*x[10],
    2*x[9]*x[10] + x[8]*x[11],
    2*x[2]*x[3] + x[8]*x[12],
    2*x[2]*x[4] + x[8]*x[13],
    ...
    2*x[2]*x[6] + x[8]*x[15],
    2*x[2]*x[7] + x[8]*x[16],
    x[9]^2 + 2*x[2]*x[14] + x[2]*x[16],
    x[3]*x[4] + 2*x[1]*x[11] + x[1]*x[13],
    2*x[2]*x[3] + x[9]*x[11],
    2*x[2]*x[4] + x[9]*x[12],
    2*x[2]*x[5] + x[9]*x[13],
    2*x[2]*x[6] + x[9]*x[14],
