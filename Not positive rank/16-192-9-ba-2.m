...
Let C be the modular curve with lmfdb label 16.192.9.ba.2.
...
C := Curve(P,[z^2 - r*s, z*t + v*r, z*t + u*s, y*w + w^2 + s^2, y*w - w^2 - \
r^2, y*t + z^2 + v^2, y^2 - w^2 + u*v, y*t - z^2 - u^2, z*v + t*s, z*u + t*r, \
t^2 - u*v, z^2 - w*t, z*s + w*v, z*r + w*u, y*u - z*r + t*v, y*v + z*s - t*u, \
y*s + z*u - w*s, y*r - z*v + w*r, y*z + z*w - v*s, y*z - z*w + u*r, 2*x^2 + y*\
z]);
