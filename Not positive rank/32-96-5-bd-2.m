...
[
    ...
    5*x[3]*x[5] + 2*x[2]*x[7],
    x[3]*x[6] + 6*x[7]*x[8],
    3*x[1]*x[5] + 6*x[1]*x[7] + 2*x[2]*x[7] + x[3]*x[7],
    2*x[2]*x[4] + 4*x[1]*x[8] + 6*x[2]*x[8] + 3*x[3]*x[8],
    2*x[1]^2 + 3*x[1]*x[2] + 5*x[1]*x[3] + x[4]^2,
    4*x[4]*x[5] + x[1]*x[6] + 5*x[2]*x[6] + 6*x[7]*x[8],
    4*x[1]*x[5] + 3*x[4]*x[6],
    4*x[1]*x[6] + 3*x[4]*x[7],
    4*x[1]*x[2] + 3*x[4]*x[8],
    x[1]*x[2] + 5*x[2]^2 + 6*x[2]*x[3] + 4*x[5]^2,
    4*x[2]*x[4] + 3*x[5]*x[6],
    4*x[1]*x[2] + 3*x[5]*x[7],
    2*x[2]*x[6] + 5*x[5]*x[8],
    4*x[1]*x[2] + 3*x[6]^2,
    ...
    2*x[3]*x[4] + 5*x[1]*x[8],
    6*x[2]*x[3] + x[8]^2,
    2*x[1]*x[2] + 4*x[1]*x[3] + 6*x[2]*x[3] + 3*x[3]^2
]
*/
