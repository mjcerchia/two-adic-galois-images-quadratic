...
Let C be the modular curve with lmfdb label 16.96.5.p.2
...
C := Curve(P,[2*y^2 + 2*y*z + t^2, 2*y*z - 2*z^2 + w^2, 4*x^2 - w*t]);
...
[
    ...
    x[3]*x[5] + x[1]*x[7] + 2*x[2]*x[7],
    2*x[1]*x[4] + x[3]*x[6],
    2*x[1]*x[5] + x[3]*x[7],
    2*x[5]*x[6] + x[3]*x[8],
    x[4]^2 + x[1]*x[7] + 2*x[2]*x[7],
    x[4]*x[5] + x[1]*x[8] + 2*x[2]*x[8],
    2*x[1]*x[5] + x[4]*x[6],
    2*x[5]*x[6] + x[4]*x[7],
    2*x[2]*x[3] + x[4]*x[8],
    x[1]*x[2] + 2*x[2]^2 + x[5]^2,
    x[3]*x[4] + x[1]*x[6] + 2*x[2]*x[6],
    2*x[2]*x[3] + x[5]*x[7],
    2*x[2]*x[4] + x[5]*x[8],
    x[6]^2 + 2*x[1]*x[7],
    x[6]*x[7] + 2*x[1]*x[8],
