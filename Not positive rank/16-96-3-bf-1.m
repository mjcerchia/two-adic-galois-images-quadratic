...
C:=Curve(P,[x*y + y*u + w*t, x*y - x*z - y*u + z^2 - w*t, x*y + x*z - y*u - z^2 - w^2 + w*t + t^2, 4*y^2 + y*u + w^2, x*w - 4*y*t + w*u - t*u, x^2 - x*y - y*u + w^2 + w*t + 3*t^2 + 2*u^2, 2*x*w - x*t + 4*y*w - w*u - t*u]);
p:=5;
