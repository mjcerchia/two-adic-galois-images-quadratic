...
Let C be the modular curve with lmfdb label 32.192.9.bh.1.
...
C := Curve(P,[x*v - u*s, x*v + t*r, v^2 - r^2 - r*s, x*v - y*v + u*r, y*r - \
u*v, x*y + t*u, x*y - y^2 + u^2, x*s - w*v, w*r + w*s + t*s, x*r + x*s + t*v, \
x^2 - w*u, y*s + t*v, x^2 - w*t - t^2, x*r + y*s - z^2, x*t + y*w, x*t - x*u -\
