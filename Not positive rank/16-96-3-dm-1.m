...
C:=Curve(P,[y^2 - z^2 + t*u, y*z + 2*w^2, x*u + y*t - y*u - z*t - z*u, x*y + x*z - y^2 - 2*y*z - z^2 - t^2, 2*x^2 + x*y + x*z + 2*y^2 + 2*z^2 + t^2 + u^2, 2*x^2 - x*y - x*z - 3*y*z + 2*w^2 + t^2, 2*x*t + 2*y*t - y*u + 2*z*t + z*u]);
p:=5;
