...
C := Curve(P,[x*z - y^2, 2*x^2 + w^2 - t^2, 4*z^2 + w*t]);
...
[
    ...
    128*x[1]^2 + x[3]^2 - 8*x[7]^2,
    x[1]*x[2] - x[7]^2,
    x[1]*x[4] - x[3]*x[6],
    x[1]*x[5] - x[4]*x[6],
    x[3]*x[4] + 128*x[1]*x[6] - 8*x[7]*x[8],
    -x[6]^2 + x[1]*x[7],
    -x[6]*x[7] + x[1]*x[8],
    8*x[2]^2 - x[5]^2 - 128*x[7]^2,
    x[2]*x[3] - x[5]*x[7],
    x[2]*x[4] - x[5]*x[8],
    x[2]*x[6] - x[7]*x[8],
    x[2]*x[7] - x[8]^2,
    -x[4]*x[5] - 128*x[6]*x[7] + 8*x[2]*x[8],
    x[3]*x[5] + 128*x[6]^2 - 8*x[8]^2,
    -x[4]*x[6] + x[3]*x[7],
    -x[5]*x[6] + x[3]*x[8],
    x[4]^2 + 128*x[6]^2 - 8*x[8]^2,
    -x[5]*x[6] + x[4]*x[7],
    -x[5]*x[7] + x[4]*x[8],
    -x[7]^2 + x[6]*x[8]
]
