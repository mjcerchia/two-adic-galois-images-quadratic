...
The folder ``Magma Code`` contains a file for each positive rank bielliptic modular curve for which Magma is used in showing it is positive rank bielliptic. The file names correspond to the LMFDB labels. 
